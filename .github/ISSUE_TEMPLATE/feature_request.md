...
Example:
- As an Unraid user, I want channel grouping so that I can organize my 500+ channels more effectively.
...
- `docker` - Docker-related enhancement
- `unraid` - Unraid-specific enhancement
